...
import nl.tue.glt.xtext.ide.contentassist.antlr.internal.InternalBoundingBoxParser;
	...
	protected String getRuleName(AbstractElement element) {
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				...
				{
					put(grammarAccess.getMoveAccess().getAlternatives_0(), "rule__Move__Alternatives_0");
					...
					put(grammarAccess.getMoveAccess().getDistanceAssignment_1(), "rule__Move__DistanceAssignment_1");
				}
			};
		}
