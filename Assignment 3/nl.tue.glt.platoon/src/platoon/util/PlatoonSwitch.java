...
public class PlatoonSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case PlatoonPackage.LEADING_VEHICLE: {
				LeadingVehicle leadingVehicle = (LeadingVehicle)theEObject;
				T result = caseLeadingVehicle(leadingVehicle);
				if (result == null) result = caseVehicle(leadingVehicle);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case PlatoonPackage.FORWARD_COMMAND: {
				ForwardCommand forwardCommand = (ForwardCommand)theEObject;
				T result = caseForwardCommand(forwardCommand);
				if (result == null) result = caseCommand(forwardCommand);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PlatoonPackage.TURN_COMMAND: {
				TurnCommand turnCommand = (TurnCommand)theEObject;
				T result = caseTurnCommand(turnCommand);
				if (result == null) result = caseCommand(turnCommand);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case PlatoonPackage.LEFT: {
				...
				if (result == null) result = caseDirection(left);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PlatoonPackage.RIGHT: {
				...
				if (result == null) result = caseDirection(right);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PlatoonPackage.HEADWAY_CONSTRAINT: {
				HeadwayConstraint headwayConstraint = (HeadwayConstraint)theEObject;
				T result = caseHeadwayConstraint(headwayConstraint);
				if (result == null) result = caseConstraint(headwayConstraint);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseLeadingVehicle(LeadingVehicle object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Forward Command</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Forward Command</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseForwardCommand(ForwardCommand object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Turn Command</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Turn Command</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseTurnCommand(TurnCommand object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Headway Constraint</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Headway Constraint</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseHeadwayConstraint(HeadwayConstraint object) {
		return null;
	}
