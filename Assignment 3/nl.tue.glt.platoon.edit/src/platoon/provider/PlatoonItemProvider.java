...
public class PlatoonItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PlatoonPackage.Literals.PLATOON__LV);
			childrenFeatures.add(PlatoonPackage.Literals.PLATOON__FV);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PlatoonPackage.Literals.PLATOON__LV,
				 PlatoonFactory.eINSTANCE.createLeadingVehicle()));

		newChildDescriptors.add
			(createChildParameter
				(PlatoonPackage.Literals.PLATOON__FV,
