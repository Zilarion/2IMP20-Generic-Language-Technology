		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Route_commands_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Route_commands_feature", "_UI_Route_type"),
				 PlatoonPackage.Literals.ROUTE__COMMANDS,
				 true,
				 false,
				 true,
				 null,
