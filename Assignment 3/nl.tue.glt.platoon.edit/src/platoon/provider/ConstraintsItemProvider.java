		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Constraints_constraints_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Constraints_constraints_feature", "_UI_Constraints_type"),
				 PlatoonPackage.Literals.CONSTRAINTS__CONSTRAINTS,
				 true,
				 false,
				 true,
				 null,
